...
export const COLORS = {
  forest:    "#2A1F1A",  // warm dark charcoal — nav, footer, cover (no green, no purple)
  gold:      "#B87FA0",  // dusty rose — PRIMARY accent (buttons, em text, badges, links)
  sandstone: "#C9A07A",  // warm sand-gold — secondary accent (eyebrows, highlights)
  cream:     "#F8F4F0",  // warm cream — primary background
  parchment: "#EDE5DF",  // warm parchment — card backgrounds
  mint:      "#F5EDF0",  // soft blush-pink — active/done states
...
export const sectionMeta = {
  ...
  venues:    { eyebrow: "Calgary - Canmore - Banff", title: "Venues", bgPhoto: "/section-bg/venues.jpg", bgPhotoCredit: "Photo courtesy of Fortuna's Row", lead: "From grand Calgary hotel ballrooms and rustic mountain barns to intimate Canmore spaces and iconic Banff resorts -- the Canadian Rockies corridor offers some of the most breathtaking wedding venues in the world.", icon: "venues" },
  ...
  photo:     { eyebrow: "Calgary", title: "Photography & Videography", bgPhoto: "/section-bg/photographers.jpg", bgPhotoCredit: "Photo courtesy of Erika Lagy Photography", lead: "Your photos and film are the memories you will revisit for the rest of your lives. Alberta's landscapes reward photographers who truly know light.", icon: "photo" },
  florists:  { eyebrow: "Calgary", title: "Florists", bgPhoto: "/section-bg/florists.jpg", bgPhotoCredit: "Photo courtesy of The Romantiks", lead: "Florals set the tone for your entire wedding aesthetic. Calgary's florist community is exceptionally talented -- and nearly all travel to Canmore and Banff.", icon: "florists" },
  cakes:     { eyebrow: "Calgary", title: "Cakes & Desserts", bgPhoto: "/section-bg/cakes.jpg", bgPhotoCredit: "Photo courtesy of Cakes by Jen YYC", lead: "From elegant tiered cakes to whimsical dessert tables, Calgary's bakers are exceptionally talented. Whatever your vision and budget, there is a baker here for you.", icon: "cakes" },
  dresses:   { eyebrow: "Calgary", title: "Wedding Dresses", bgPhoto: "/section-bg/dresses.jpg", bgPhotoCredit: "Photo courtesy of Rahime Gül", lead: "Finding your dress is one of the most magical moments of wedding planning. We recommend visiting each of these boutiques in person -- no online browsing compares to trying on the real thing.", icon: "dresses" },
  hair:      { eyebrow: "Calgary", title: "Hair & Makeup", bgPhoto: "/section-bg/hair.jpg", bgPhotoCredit: "Photo courtesy of Blush & Coco Brides", lead: "The right hair and makeup artist makes you feel like yourself -- only more so. Calgary's bridal beauty artists are exceptionally talented, and most travel to Canmore and Banff.", icon: "hair" },
  ...
  "van-venues":   { eyebrow: "Vancouver - Squamish - Whistler - Pemberton", title: "Venues", bgPhoto: "/section-bg/van-venues.jpg", bgPhotoCredit: "Photo courtesy of The Permanent", lead: "From grand Vancouver hotel ballrooms and waterfront spaces to intimate heritage venues, botanical gardens, and Sea-to-Sky mountain escapes -- the West Coast offers some of Canada's most breathtaking wedding settings.", icon: "venues" },
  ...
  "van-photo":    { eyebrow: "Vancouver & Sea-to-Sky", title: "Photography & Videography", bgPhoto: "/section-bg/van-photographers.jpg", bgPhotoCredit: "Photo courtesy of The Apartment Photography", lead: "BC's landscapes -- ocean, forest, mountain -- reward photographers who truly know light. These are the best in the region.", icon: "photo" },
  "van-florists": { eyebrow: "Vancouver & Sea-to-Sky", title: "Florists", bgPhoto: "/section-bg/van-florists.jpg", bgPhotoCredit: "Photo courtesy of The Wild Bunch", lead: "From lush romantic arrangements to organic, nature-inspired designs, Vancouver's florist community is exceptionally talented -- and many travel the Sea-to-Sky corridor.", icon: "florists" },
  "van-cakes":    { eyebrow: "Vancouver & Sea-to-Sky", title: "Cakes & Desserts", bgPhoto: "/section-bg/van-cakes.jpg", bgPhotoCredit: "Photo courtesy of Cadeaux Bakery", lead: "From modern minimalist tiered cakes to whimsical structural creations, Vancouver's bakers bring exceptional craft to your wedding table.", icon: "cakes" },
  ...
  "van-hair":     { eyebrow: "Vancouver & Sea-to-Sky", title: "Hair & Makeup", bgPhoto: "/section-bg/van-hair.jpg", bgPhotoCredit: "Photo courtesy of AMORE by BEA", lead: "The right artist makes you feel like yourself -- only more so. Vancouver's bridal beauty team is world-class, and most travel the Sea-to-Sky corridor.", icon: "hair" },
