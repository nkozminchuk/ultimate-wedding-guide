...
export const sectionMeta = {
  ...
  coming:    { eyebrow: "Canadian Rockies Edition", title: "On Our Radar", lead: "We are constantly scouting, vetting, and adding to this guide. Consider this your insider preview of what's coming — and a reminder that the best vendors book fast.", icon: "coming" },
    "van-venues":   { eyebrow: "Vancouver Â· Squamish Â· Whistler Â· Pemberton", title: "Venues", lead: "From grand Vancouver hotel ballrooms and waterfront spaces to intimate heritage venues, botanical gardens, and Sea-to-Sky mountain escapes â€” the West Coast offers some of Canada's most breathtaking wedding settings.", icon: "venues" },
  ...
  "van-bar":      { eyebrow: "Vancouver & Sea-to-Sky", title: "Mobile Bar Services", lead: "BC's Special Event Permit (SEP) system governs alcohol at private events. Here's everything you need to know â€” and the best mobile bar services in the region.", icon: "bar" },
  "van-photo":    { eyebrow: "Vancouver & Sea-to-Sky", title: "Photography & Videography", lead: "BC's landscapes â€” ocean, forest, mountain â€” reward photographers who truly know light. These are the best in the region.", icon: "photo" },
  "van-florists": { eyebrow: "Vancouver & Sea-to-Sky", title: "Florists", lead: "From lush romantic arrangements to organic, nature-inspired designs, Vancouver's florist community is exceptionally talented â€” and many travel the Sea-to-Sky corridor.", icon: "florists" },
  ...
  "van-hair":     { eyebrow: "Vancouver & Sea-to-Sky", title: "Hair & Makeup", lead: "The right artist makes you feel like yourself â€” only more so. Vancouver's bridal beauty team is world-class, and most travel the Sea-to-Sky corridor.", icon: "hair" },
  "van-rentals":  { eyebrow: "Vancouver & Sea-to-Sky", title: "Event Rentals", lead: "From furniture and linens to custom builds and statement dÃ©cor, these companies help bring your West Coast wedding vision to life.", icon: "venues" },
