...
export const sectionMeta = {
  ...
  "van-florists": { eyebrow: "Vancouver & Sea-to-Sky", title: "Florists", lead: "From lush romantic installations to organic mountain-inspired arrangements, the West Coast floral community is exceptional. Most Vancouver florists travel regularly to the Sea-to-Sky.", icon: "florists" },
  ...
  "van-hair": { eyebrow: "Vancouver & Sea-to-Sky", title: "Hair & Makeup", bgPhoto: "/section-bg/van-hair.jpg", bgPhotoCredit: "Photo courtesy of AMORE by BEA", bgPhotoSize: "80%", lead: "The right hair and makeup artist makes you feel like yourself -- only more so. Vancouver and Sea-to-Sky's bridal beauty artists are exceptionally talented.", icon: "hair" },  
