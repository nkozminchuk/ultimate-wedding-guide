...
// Field order: Style → Services → Pricing → Consultations → Travel → Booking → Note → Instagram → Website
// =============================================================================
...
export const floristData = [
  ...
  { name: "Adventure Floral", tier: "$", fields: [
    { label: "Style", value: "Organic, whimsical, nature-inspired — perfect for mountain and outdoor settings" },
    { label: "Services", value: "Full service and partial service; studio pickup also available — whatever works best for the couple" },
    { label: "Pricing", value: "No minimum spend; elopement florals available when paired with other same-date weddings" },
    { label: "Consultations", value: "Phone consults or in-person at a Calgary coffee shop" },
    { label: "Travel", value: "Canmore, Banff & surrounding areas — approximately 90% of weddings are in Canmore" },
    { label: "Booking", value: "Minimum 3 weeks notice to guarantee flower availability; bookings accepted up to a year in advance" },
...
export const floristPending = ["Flower Aura by Natasha", "Kensington Florist", "Pine for Cedar", "Le Bouquet Floral", "Flower Artistry", "Black Earth Floral", "Flowers by Janie", "Flower Culture YYC", "La Maison Flower Studio", "Callia Florals", "Blue Lakes Floral Design"];
