// =============================================================================
// DATA / FLORISTS.JS — Calgary florists (most travel to Canmore & Banff)
// Field order: Style → Services → Pricing → Consultations → Travel → Booking
//   → Note → Instagram → Website
// =============================================================================
...
export const floristData = [
  { name: "Small Flower", tier: "$", fields: [
    ...
    { label: "Services", value: "Full service; a la carte menu available" },
    { label: "Pricing", value: "A la carte from under $2,500; full service custom quoted" },
  ...
  { name: "The Romantiks", tier: "$/$$", fields: [
    ...
    { label: "Pricing", value: "$2,500 minimum during peak season (May to November)" },
  ...
  { name: "Jarman Flower Shop", tier: "$/$$", fields: [
    ...
    { label: "Booking", value: "3 to 6 months recommended" },
  ...
  { name: "Among the Wildflwrs", tier: "$$/$$$ ", fields: [
    ...
    { label: "Services", value: "Full service; selective a la carte bookings" },
    { label: "Pricing", value: "From $3,500 to $5,000; most couples invest $5,000 to $8,000+" },
    { label: "Consultations", value: "Complimentary consultations offered" },
    { label: "Travel", value: "Calgary, Canmore, Banff & surrounding areas" },
    { label: "Booking", value: "6 to 12+ months recommended for peak season" },
    { label: "Instagram", value: "@amongthewldflwrs" },
    { label: "Website", value: "amongthewldflwrs.com", link: "https://www.amongthewldflwrs.com" },
  ]},

  { name: "Adventure Floral", tier: "$/$$", fields: [
    { label: "Style", value: "Organic, whimsical, nature-inspired designs" },
    { label: "Specialty", value: "Weddings, events, elopements, and micro-weddings" },
    { label: "Services", value: "Full service and partial service -- everything from full installations to pick-up from studio, whatever works best for the couple" },
    { label: "Pricing", value: "No minimum spend; elopements available when working on other weddings on the same date -- charged only for flowers" },
    { label: "Consultations", value: "Yes -- phone consults or in-person at a Calgary coffee shop" },
    { label: "Travel", value: "Yes -- approximately 90% of weddings are in Canmore; also serves Banff and surrounding mountain venues" },
    { label: "Booking", value: "Minimum 3 weeks needed to guarantee flower availability; can book up to a year in advance" },
    { label: "Instagram", value: "@adventurefloral" },
    { label: "Website", value: "adventurefloral.ca", link: "https://www.adventurefloral.ca" },
  ]},
];

export const floristPending = [
