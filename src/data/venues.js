...
export const venueData = [
  ...
  },
  {
    ...
    vendors: [
      {
        name: "Cornerstone Weddings — The Rundleview Room",
        tier: "$$",
        fields: [
          { label: "Style", value: "Mountain-view reception hall inside the Canmore Nordic Centre Day Lodge — soaring windows, vaulted wood ceilings, and Nordic fairytale lights. One wedding per day guaranteed." },
          { label: "Pricing", value: "Minimum spend: Sat/Fri/Sun $14,000 · Mid-week $12,000 (Jan–Dec 2027). Ceremony package $1,800 (outdoor) or $1,400 (indoor). Reception package $4,500 (Sat/Fri/Sun) or $4,000 (mid-week). All packages count toward minimum spend. +20% service charge and +5% GST applied separately." },
          { label: "Capacity", value: "Up to 80 guests" },
          { label: "Catering", value: "In-house only — Executive Chef menus from bespoke buffets to gourmet plated dinners; full bar team on site" },
          { label: "Ceremony", value: "Outdoor: choice of Tree Island (private forested setting) or Cross Country Stadium (sweeping mountain views). Indoor backup always available. Both include chairs, signing table, archway, PA & mic." },
          { label: "Parking", value: "Available at the Nordic Centre Day Lodge" },
          { label: "Includes", value: "Personal Wedding Coordinator, 2-hour food tasting & planning meeting, full setup & takedown (including your own décor), day-of Event Manager, all servers & bartenders, décor pickup next morning before 11am. No fees for cake cutting, security, SOCAN, or cleaning." },
          { label: "Extras", value: "In-house DJ ($1,600 · counts toward minimum spend), curated décor packages, champagne tower, marquee lights, stationery, Polaroid cameras, dessert station backdrop. Ceremony cocktail hour add-on (Toast the I Do's): $27/person — prosecco, 3 appetizers, serving staff." },
          { label: "Booking", value: "Requires signed agreement + $2,500 non-refundable deposit. Nordic Centre confirms bookings 12 months in advance; earlier bookings are tentative." },
          { label: "Note", value: "Venue is private from 5:30pm onwards; on-site security included at no charge. No accommodation on site — discount codes with local hotels provided.", full: true },
          { label: "Phone", value: "403.609.0004" },
          { label: "Email", value: "info@cornerstonecanmore.com" },
          { label: "Website", value: "weddingswithcornerstone.com", link: "https://weddingswithcornerstone.com" },
        ],
      },
      {
        name: "Cornerstone Weddings — Cornerstone Theatre",
        tier: "$$/$$$$",
        fields: [
          { label: "Style", value: "Dramatic barn-style theatre with reclaimed wood walls, soaring ceilings, a grand chandelier, and a raised stage — the most atmospheric of the Cornerstone venues. Ceremonies held outdoors at the private Canmore Ranch." },
          { label: "Pricing", value: "Minimum spend: Nov–Apr all days $16,000. May–Oct: Sat $23,000 · Fri/Sun $20,000 · Mid-week $18,000. Ceremony package $2,600 (outdoor ranch) or $1,500 (indoor theatre) or $2,000 (Winter Wonderland). Reception package: $7,100/$7,000/$6,500 (peak) · $5,000 (off-peak). All packages count toward minimum spend. +20% service charge and +5% GST applied separately. Statutory holidays and Dec 31 incur $23,000 minimum." },
          { label: "Capacity", value: "Up to 180 guests" },
          { label: "Catering", value: "In-house only — Executive Chef menus from buffets to gourmet plated dinners; full bar team on site" },
          { label: "Ceremony", value: "Outdoor at Canmore Ranch (private, exclusive access, bathrooms & free parking on site) or indoor at Cornerstone Theatre. Winter Wonderland option ($2,000): outdoor ceremony at the Ranch with warming donut tent, wood-burning fire, and blankets. Outdoor cocktail hour add-on (Toast the I Do's): $27/person." },
          { label: "Parking", value: "Free parking at Canmore Ranch; venue is within walking distance of local hotels and condos" },
          { label: "Includes", value: "Personal Wedding Coordinator, 2-hour food tasting & planning meeting, full setup & takedown, day-of Event Manager, all servers & bartenders, décor pickup next morning before 11am. No fees for cake cutting, security, SOCAN, or cleaning. Venue rental until 2am." },
          { label: "Extras", value: "In-house DJ ($1,600 · counts toward minimum spend), cold sparkler fireworks, photobooth, champagne tower, stationery packages, Polaroid cameras, extra room lighting. Complimentary décor includes fairy light backdrop, mini chandelier, marquee/neon sign, napkin colour choice, farmhouse tables and vineyard chairs with cushions. Horse-drawn carriage (+$350) or sleigh ride (+$350) available." },
          { label: "Booking", value: "Requires signed agreement + $2,500 non-refundable deposit. Winter weddings available Nov–Apr." },
          { label: "Note", value: "Canmore Ranch is one of the few private ceremony locations in Canmore with unobstructed mountain views. Theatre is a year-round venue — the only Cornerstone option open in winter.", full: true },
          { label: "Phone", value: "403.609.0004" },
          { label: "Email", value: "info@cornerstonecanmore.com" },
          { label: "Website", value: "weddingswithcornerstone.com", link: "https://weddingswithcornerstone.com" },
        ],
      ...
      {
        name: "Cornerstone Weddings — The Vista",
        tier: "$$$",
        fields: [
          { label: "Style", value: "Sleek, modern venue at the Canmore Nordic Centre with floor-to-ceiling windows, a rooftop ceremony deck, and wrap-around patio overlooking the mountains. The most elevated and contemporary of the Cornerstone venues." },
          { label: "Pricing", value: "May–Oct only. Minimum spend: Sat $25,000 · Fri/Sun $22,000 · Mid-week $19,000. Ceremony package $2,500 (outdoor rooftop) or $1,500 (indoor). Reception package $7,200/$7,200/$6,700. All packages count toward minimum spend. +20% service charge and +5% GST applied separately. Statutory holidays: $25,000 minimum." },
          { label: "Capacity", value: "Up to 150 guests" },
          { label: "Catering", value: "In-house only — Executive Chef menus from buffets to gourmet plated dinners; full bar team on site" },
          { label: "Ceremony", value: "Outdoor on The Vista rooftop (2-hour rental, chairs, signing table, archway, PA & mic) with indoor backup always available. Indoor ceremony option also available ($1,500). Cocktail hour add-on (Toast the I Do's): $27/person — prosecco wall, 3 appetizers, serving staff." },
          { label: "Parking", value: "Available at the Nordic Centre; venue confirmed 12 months in advance (earlier bookings are tentative)" },
          { label: "Includes", value: "Personal Wedding Coordinator, 2-hour food tasting & planning meeting, full setup & takedown, day-of Event Manager, all servers & bartenders, décor pickup next morning before 11am. No fees for cake cutting, security, SOCAN, or cleaning. Venue rental until 2am including lobby and wrap-around patio." },
          { label: "Extras", value: "In-house DJ ($1,600 · counts toward minimum spend), cold sparkler fireworks, photobooth, champagne tower, stationery packages, Polaroid cameras, extra lighting. Complimentary décor includes wooden dance floor, mirrored seating chart, marquee/neon sign, choice of napkin colours and tablecloths." },
          { label: "Booking", value: "Requires signed agreement + $2,500 non-refundable deposit. May–October only — no winter weddings at this venue." },
          { label: "Note", value: "Government-owned sporting facility — seasonal availability only (May–Oct). Exclusive hotel discount codes provided for guests. No on-site accommodation.", full: true },
          { label: "Phone", value: "403.609.0004" },
          { label: "Email", value: "info@cornerstonecanmore.com" },
          { label: "Website", value: "weddingswithcornerstone.com", link: "https://weddingswithcornerstone.com" },
        ],
      ...
      {
        name: "The Gem & Mainspace — The Collective",
        tier: "$/$$",
        fields: [
          { label: "Style", value: "Two distinct Canmore venues under The Collective umbrella. The Gem is a stunning multi-level events centre in the heart of Canmore; Mainspace is an intimate, flexible space ideal for smaller celebrations. Both supported by in-house photography, videography, florals, decor, DJ, and coordination services." },
          ...
          { label: "Extras", value: "Full-service planning through The Collective — in-house photography, videography, florals, decor, DJ, transportation, accommodation & coordination all available" },
          { label: "Instagram", value: "@thegem.ca / @mainspace_canmore / @wearethecollective.ca" },
          { label: "Website", value: "thegem.ca / mainspacecanmore.ca", link: "https://thegem.ca" },
        ],
      },
      {
